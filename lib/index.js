 ...
 */
export function createDarkModeTheme(lightTheme, customizations) {
    const domainTheme = Theme.create({
        version: lightTheme.version,
        color: {
            palette: ColorPalette.create(lightTheme.tokens.color.palette),
            text: TextColor.create(lightTheme.tokens.color.text),
            background: BackgroundColor.create(lightTheme.tokens.color.background),
            border: BorderColor.create(lightTheme.tokens.color.border)
        },
 ...
 */
export async function mergeThemes(themes, options) {
 ...
 */
export function createThemeFromPreset(presetName, customizations) {
...
export const themePerformance = {
    ...
    recordRender: (themeId, renderTime) => {
        const performanceService = ThemePerformanceService.getInstance();
